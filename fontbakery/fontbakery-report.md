...
* 🔥 **FAIL** OS/2 sTypoAscender (756) and hhea ascent (1500) must be equal. [code: ascender]
...
* ⚠ **WARN** We recommend the absolute sum of the hhea metrics should be between 1.2-1.5x of the font's upm. This font has 1.744x (1744) [code: bad-hhea-range]
